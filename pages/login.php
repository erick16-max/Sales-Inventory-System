...
<head>
  ...
  <link rel="icon" href="../img/sales.png">
              ...
              <div class="col-lg-">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Sales and Inventory System!</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="btn btn-primary btn-user btn-block" type="submit" name="btnlogin">Login&nbsp;<i class="fas fa-sign-in-alt"></i></button>
                    <hr>
                  <!-- <div class="text-center">
