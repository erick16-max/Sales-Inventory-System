...
$opt = "<select class='form-control'  style='border-radius: 0px;' name='customer' >
...
?> 
          ...
          <div class="form-group row text-left mb-3">
            ...
            <button type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;" disabled>Billing System&nbsp;<i class="fas fa-fw fa-calculator"></i></button>
            </div>
          ...
          <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
              <div class="input-group mb-2">
                ...
                <input type="hidden" class="form-control text-right " value="<?php echo number_format($lessvat, 2); ?>" readonly name="lessvat">
     
                <input type="hidden" class="form-control text-right " value="<?php echo number_format($netvat, 2); ?>" readonly name="netvat">
             
                <input type="hidden" class="form-control text-right " value="<?php echo number_format($addvat, 2); ?>" readonly name="addvat">
                    ...
                    <div class="col-sm-12 mb-2">
                      <div class="input-group mb-2">
                        <div class="input-group-prepend">
                          ...
                          <input class="form-control text-right" id="txtNumber"  type="number" name="cash" placeholder="ENTER CASH"  required>
                    </div>
                  </div>
              </div>
